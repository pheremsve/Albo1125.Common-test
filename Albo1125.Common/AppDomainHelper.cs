...
namespace Albo1125.Common
{
    ...
    {
        /// <summary>
        /// Delegate for invoking a method across AppDomains with a payload.
        /// </summary>
        /// <param name="payload">The parameters to pass to the method being invoked.</param>
        public delegate void CrossAppDomainCallDelegate(params object[] payload);

        /// <summary>
        /// Delegate for invoking a method across AppDomains with a payload and returning a result.
        /// </summary>
        /// <param name="payload">The parameters to pass to the method being invoked.</param>
